  ...
  return (
    <div className="fade-in">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6 text-center">
        ...
        <p className="text-gray-500 text-sm mt-2">Kies uw taal / Choose your language</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {LANGUAGES.map((lang) => (
          <button
            ...
            className="group bg-white hover:bg-blue-50 border-2 border-gray-200 hover:border-blue-400 rounded-xl p-4 flex flex-col items-center gap-2 transition-all duration-200 hover:shadow-lg hover:scale-105 active:scale-95 min-h-[80px]"
          >
            <span className="text-5xl" role="img" aria-label={lang.name}>
              {lang.flag}
            </span>
            <div className="text-center">
              <div className="font-bold text-gray-800 text-base group-hover:text-blue-700">
                {lang.nativeName}
              </div>
