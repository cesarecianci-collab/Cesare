...
const formulas = [
  {
    ...
    items: ['Broodstokjes', 'Feta kaas', 'Tzatziki', 'Pikante fetadip (chtipiti)', 'Olijven', 'Rode bietendip', 'Dolmadakia'],
    badge: null,
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    items: ['Gyros · Souvlaki · Kip souvlaki', 'Kefte + Gefrituurde calamari', 'Frietjes + Pitabrood', 'Griekse pasta', 'Gegrilde groenten', 'Salade + Tzatziki', 'Rode bietendip + Chtipiti'],
    badge: null,
    highlight: false,
  },
  {
    ...
    items: ['Gyros · Souvlaki · Kip · Kefte', 'Worst + Lamskotelet', 'Gefrituurde calamari', 'Griekse pasta + Gegrilde groenten', 'Tzatziki · Chtipiti · Rode bietensalade', 'Spinaziesalade + Griekse koolsalade', 'Frietjes + Pitabrood'],
    badge: 'Premium',
    highlight: false,
  },
  {
